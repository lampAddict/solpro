...
class TransportController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $sql = 'SELECT t.*, rvt.name as tname, rvct.name as pname FROM transport t LEFT JOIN refvehicletype rvt ON rvt.id = t.type LEFT JOIN refvehiclecarryingtype rvct ON rvct.id = t.payload WHERE '.$where.' ORDER BY t.id DESC';
